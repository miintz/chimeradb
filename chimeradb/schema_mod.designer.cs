...
namespace genericdbgenerator
{
    ...
    {                        
        ...
        private List<qcaseType> tableField;

        private static System.Xml.Serialization.XmlSerializer serializer;

        public telitabType()
        {
            this.tableField = new List<qcaseType>();
    ...
    public partial class parameterTypeVal
    {
        ...
        //telitabType, string, int, binType
    ...
    [System.Xml.Serialization.XmlRootAttribute(Namespace = "", IsNullable = true)]
    [TypeDescriptionProvider(typeof(HyperTypeDescriptionProvider))]
    public partial class qcaseType
    {
        ...
        private static System.Xml.Serialization.XmlSerializer Serializer
        {
            get
            {
                if ((serializer == null))
                {
                    serializer = new System.Xml.Serialization.XmlSerializer(typeof(qcaseType));
                }
                return serializer;
            }
        }
        ...
        #region Serialize/Deserialize
        /// <summary>
        /// Serializes current qcaseType object into an XML document
        /// </summary>
        /// <returns>string XML value</returns>
        public virtual string Serialize()
        {
        ...
        /// <summary>
        /// Deserializes workflow markup into an qcaseType object
        /// </summary>
        /// <param name="xml">string workflow markup to deserialize</param>
        /// <param name="obj">Output qcaseType object</param>
        /// <param name="exception">output Exception value if deserialize failed</param>
        /// <returns>true if this XmlSerializer can deserialize the object; otherwise, false</returns>
        public static bool Deserialize(string xml, out qcaseType obj, out System.Exception exception)
        {
            exception = null;
            obj = default(qcaseType);
            try
            {
                obj = Deserialize(xml);
                return true;
        ...
        public static bool Deserialize(string xml, out qcaseType obj)
        {
            System.Exception exception = null;
            return Deserialize(xml, out obj, out exception);
        }

        public static qcaseType Deserialize(string xml)
        {
            System.IO.StringReader stringReader = null;
            try
            {
                stringReader = new System.IO.StringReader(xml);
                return ((qcaseType)(Serializer.Deserialize(System.Xml.XmlReader.Create(stringReader))));
            }
            finally
            {
                if ((stringReader != null))
        ...
        /// <summary>
        /// Serializes current qcaseType object into file
        /// </summary>
        /// <param name="fileName">full path of outupt xml file</param>
        /// <param name="exception">output Exception value if failed</param>
        /// <returns>true if can serialize and save into file; otherwise, false</returns>
        ...
        /// <summary>
        /// Deserializes xml markup from file into an qcaseType object
        /// </summary>
        /// <param name="fileName">string xml file to load and deserialize</param>
        /// <param name="obj">Output qcaseType object</param>
        /// <param name="exception">output Exception value if deserialize failed</param>
        /// <returns>true if this XmlSerializer can deserialize the object; otherwise, false</returns>
        public static bool LoadFromFile(string fileName, out qcaseType obj, out System.Exception exception)
        {
            exception = null;
            obj = default(qcaseType);
            try
        ...
        public static bool LoadFromFile(string fileName, out qcaseType obj)
        {
            System.Exception exception = null;
            return LoadFromFile(fileName, out obj, out exception);
        }

        public static qcaseType LoadFromFile(string fileName)
        {
            System.IO.FileStream file = null;
            System.IO.StreamReader sr = null;
            try
    ...
    public partial class expressionType
    {
        ...
        private expressionTypeRef refField;
        ...
        {
            this.binField = new binType();
            this.refField = new expressionTypeRef();
    ...
    [System.Xml.Serialization.XmlTypeAttribute(AnonymousType = true)]
    [TypeDescriptionProvider(typeof(HyperTypeDescriptionProvider))]
    public partial class expressionTypeRef
    {

        private expressionTypeRefReftext reftextField;

        private static System.Xml.Serialization.XmlSerializer serializer;

        public expressionTypeRef()
        {
            this.reftextField = new expressionTypeRefReftext();
        }

        [System.Xml.Serialization.XmlElementAttribute(Order = 0)]
        public expressionTypeRefReftext reftext
        {
            get
            {
                return this.reftextField;
        ...
        private static System.Xml.Serialization.XmlSerializer Serializer
        {
            get
            {
                if ((serializer == null))
                {
                    serializer = new System.Xml.Serialization.XmlSerializer(typeof(expressionTypeRef));
                }
                return serializer;
            }
        }
        ...
        #region Serialize/Deserialize
        /// <summary>
        /// Serializes current expressionTypeRef object into an XML document
        /// </summary>
        /// <returns>string XML value</returns>
        public virtual string Serialize()
        {
        ...
        /// <summary>
        /// Deserializes workflow markup into an expressionTypeRef object
        /// </summary>
        /// <param name="xml">string workflow markup to deserialize</param>
        /// <param name="obj">Output expressionTypeRef object</param>
        /// <param name="exception">output Exception value if deserialize failed</param>
        /// <returns>true if this XmlSerializer can deserialize the object; otherwise, false</returns>
        public static bool Deserialize(string xml, out expressionTypeRef obj, out System.Exception exception)
        {
            exception = null;
            obj = default(expressionTypeRef);
            try
            {
                obj = Deserialize(xml);
                return true;
        ...
        public static bool Deserialize(string xml, out expressionTypeRef obj)
        {
            System.Exception exception = null;
            return Deserialize(xml, out obj, out exception);
        }

        public static expressionTypeRef Deserialize(string xml)
        {
            System.IO.StringReader stringReader = null;
            try
            {
                stringReader = new System.IO.StringReader(xml);
                return ((expressionTypeRef)(Serializer.Deserialize(System.Xml.XmlReader.Create(stringReader))));
            }
            finally
            {
                if ((stringReader != null))
        ...
        /// <summary>
        /// Serializes current expressionTypeRef object into file
        /// </summary>
        /// <param name="fileName">full path of outupt xml file</param>
        /// <param name="exception">output Exception value if failed</param>
        /// <returns>true if can serialize and save into file; otherwise, false</returns>
        ...
        /// <summary>
        /// Deserializes xml markup from file into an expressionTypeRef object
        /// </summary>
        /// <param name="fileName">string xml file to load and deserialize</param>
        /// <param name="obj">Output expressionTypeRef object</param>
        /// <param name="exception">output Exception value if deserialize failed</param>
        /// <returns>true if this XmlSerializer can deserialize the object; otherwise, false</returns>
        public static bool LoadFromFile(string fileName, out expressionTypeRef obj, out System.Exception exception)
        {
            exception = null;
            obj = default(expressionTypeRef);
            try
        ...
        public static bool LoadFromFile(string fileName, out expressionTypeRef obj)
        {
            System.Exception exception = null;
            return LoadFromFile(fileName, out obj, out exception);
        }

        public static expressionTypeRef LoadFromFile(string fileName)
        {
            System.IO.FileStream file = null;
            System.IO.StreamReader sr = null;
            try
    ...
    [System.Xml.Serialization.XmlTypeAttribute(AnonymousType = true)]
    [TypeDescriptionProvider(typeof(HyperTypeDescriptionProvider))]
    public partial class expressionTypeRefReftext
    {
        ...
        private static System.Xml.Serialization.XmlSerializer Serializer
        {
            get
            {
                if ((serializer == null))
                {
                    serializer = new System.Xml.Serialization.XmlSerializer(typeof(expressionTypeRefReftext));
                }
                return serializer;
            }
        }
        ...
        #region Serialize/Deserialize
        /// <summary>
        /// Serializes current expressionTypeRefReftext object into an XML document
        /// </summary>
        /// <returns>string XML value</returns>
        public virtual string Serialize()
        {
        ...
        /// <summary>
        /// Deserializes workflow markup into an expressionTypeRefReftext object
        /// </summary>
        /// <param name="xml">string workflow markup to deserialize</param>
        /// <param name="obj">Output expressionTypeRefReftext object</param>
        /// <param name="exception">output Exception value if deserialize failed</param>
        /// <returns>true if this XmlSerializer can deserialize the object; otherwise, false</returns>
        public static bool Deserialize(string xml, out expressionTypeRefReftext obj, out System.Exception exception)
        {
            exception = null;
            obj = default(expressionTypeRefReftext);
            try
            {
                obj = Deserialize(xml);
                return true;
        ...
        public static bool Deserialize(string xml, out expressionTypeRefReftext obj)
        {
            System.Exception exception = null;
            return Deserialize(xml, out obj, out exception);
        }

        public static expressionTypeRefReftext Deserialize(string xml)
        {
            System.IO.StringReader stringReader = null;
            try
            {
                stringReader = new System.IO.StringReader(xml);
                return ((expressionTypeRefReftext)(Serializer.Deserialize(System.Xml.XmlReader.Create(stringReader))));
            }
            finally
            {
                if ((stringReader != null))
        ...
        /// <summary>
        /// Serializes current expressionTypeRefReftext object into file
        /// </summary>
        /// <param name="fileName">full path of outupt xml file</param>
        /// <param name="exception">output Exception value if failed</param>
        /// <returns>true if can serialize and save into file; otherwise, false</returns>
        ...
        /// <summary>
        /// Deserializes xml markup from file into an expressionTypeRefReftext object
        /// </summary>
        /// <param name="fileName">string xml file to load and deserialize</param>
        /// <param name="obj">Output expressionTypeRefReftext object</param>
        /// <param name="exception">output Exception value if deserialize failed</param>
        /// <returns>true if this XmlSerializer can deserialize the object; otherwise, false</returns>
        public static bool LoadFromFile(string fileName, out expressionTypeRefReftext obj, out System.Exception exception)
        {
            exception = null;
            obj = default(expressionTypeRefReftext);
            try
        ...
        public static bool LoadFromFile(string fileName, out expressionTypeRefReftext obj)
        {
            System.Exception exception = null;
            return LoadFromFile(fileName, out obj, out exception);
        }

        public static expressionTypeRefReftext LoadFromFile(string fileName)
        {
            System.IO.FileStream file = null;
            System.IO.StreamReader sr = null;
            try
    ...
    public partial class qkb
    {
        ...
        private List<expressionType> relationsField;
        ...
        public qkb()
        {
            ...
            this.relationsField = new List<expressionType>();
        ...
        public List<expressionType> relations
        {
            get
            {
