    ...
    public partial class GenerateDB : Form
    {
        ...
        public void EvaluateStructure(object Structure, object[] returners, Int32 ElementId, Boolean IncludeGeneratedContextInProject = false)
        {
            ...
            /*
             ...
             Blijkbaar is BULKEN een stuk sneller dan SaveChange. Vraag me niet waarom, maar deze test wijst dat uit. 
            ...
            */
             ...
             *  1AUG2014
             *  
             * Hallo, terug van weggeweest etc. 
             * 
             * Er gaat hier iets fout met namespaces. Als het type een namespace heeft gaat het mis, ff via een hack gefixed nu. Maar dit moet nog wel opgepakt worden. 
             * 
             * TODO: Gaat fout als de namespace van het object-te-databasen geen 'genericdbgenerator' is
             */

            String hackfixnamehack = string.Empty;
            String[] split = TypeOfMainDbSetName.Split(new char[] { '.' });

            TypeOfMainDbSetName = "genericdbgenerator." + split[1];
            ...
            foreach (PropertyInfo field in fiarrayfull)
            {
                ...
                else
                {
                    ...
                    else
                    {
                         ...
                         * 1 AUG 2014
                         * 
                         * TODO: Hier gebeurd het dus ook. Namespace neuzel, verzin hier eens wat op?
                         */

                        String FieldTypeName = field.PropertyType.FullName;

                        //hackzorz
                        FieldTypeName = FieldTypeName.Replace("OpenWeather", "genericdbgenerator");
        ...
        private int EvaluateList(IEnumerable ListToEvaluate, Int32 ElementId, Type RecursionType, Assembly DataAssembly, List<IList> ListOfTableLists, Type[] GenericTypes)
        {
            ...
            foreach (PropertyInfo field in FieldsInValue)
            {
                ...
                else
                {
                    ...
                    else
                    {
                        ...
                        //waarschijnlijk een speciaal type. Op naar EvaluateSpecialType dus , we moeten de ElementId uniek houden, dus ref die shit
        ...
        private void CopyToDatabase(List<IList> ListOfTableLists, string[] TableNames, Type[] GenericTypes, String ConnectionString)
        {
            ...
            for (int i = 0; i < ListOfTableLists.Count; i++)
            {
                ...
                /* 
                 * TODO: Hier gaat iets mis met datetime, soort van format ding ofzo? of dit:http://forums.asp.net/t/1922214.aspx?SqlDateTime+overflow+Must+be+between+1+1+1753+12+00+00+AM+and+12+31+9999+11+59+59+PM+
                 * Een null dus
                 * 
                 * Lijkst alsof de Data variable geen waarde heeft...
                 */
        ...
        public object[] GenerateTablesForType(Type RecursionType, object RecursionTypeContent, Boolean IncludeGeneratedContextInProject = false)
        {
            ...
            String connectionstring = "Data Source=(local)\\SQLSUPEREXPRESS;Initial Catalog=" + contextname + ";Integrated Security=True;Pooling=False;";
            ...
            /*
             * NTS: Als dit misloopt op bla-bla, check of velden in je model het juiste type hebben. dus geen ushort maar decimal bijv
             */
